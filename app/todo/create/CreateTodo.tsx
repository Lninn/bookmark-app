...
export default function CreateTodo() {
  ...
  function getValues(target) {
    const elements = target.childNodes

    const values = { fill: "gray" }
  ...
  return (
    <div className="bg-white h-screen">
      ...
      <div className="pt-36 px-8">
        <form id="create-todo" onSubmit={onSubmit}>
          <input
            type="text"
      ...
      <button
        form="create-todo"
        className="fixed bottom-12 right-12 bg-[#6a44d9] px-6 py-2 text-base text-white rounded-3xl font-light"
      >
        New task
      </button>
    </div>
